...
set frame01 [atomselect top "chain A and protein and backbone" frame 0]
set frame0 [atomselect top "chain A and protein and name CA" frame 0]
for {set ix 1 } {$ix < $nframes } { incr ix } {
		set selx [atomselect top "chain A and protein and name CA" frame $ix]
		set all [atomselect top all frame $ix]
		$all move [measure fit $selx $frame0]
	}

 ######################################################
set sel [atomselect top "protein and chain A"]
set waters [atomselect top "(protein and chain A) and (pbwithin 10 of chain A)"]
...
for {set i 0} {$i < $nframes} {incr i} {
		...
		set selrms [atomselect top "protein and backbone and chain A" frame $i]
	...
	set D [atomselect top "protein and chain A"]
	...
	set A1 [atomselect top "protein and chain A"]
	set D2 [atomselect top "protein and chain A"]
...
##**Calculation of RMSF
set sel1 [atomselect top "protein and chain A and name CA"]
